     ...
     begin
       ...
       if DMConnect.RxInput.FieldByName('ID').asinteger = 0 then
         begin
           ...
           DMConnect.zqbirds.sql.add('(inputid, inputtype, valor)');
           DMConnect.zqbirds.sql.add('values');
           DMConnect.zqbirds.sql.add('(:ainputid, :ainputtype, :avalor)');
           DMConnect.zqbirds.ParamByName('ainputid').asstring :=DMConnect.RxInput.FieldByName('ID').asstring;
